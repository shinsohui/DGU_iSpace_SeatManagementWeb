		...
		<div align="center">
			<nav id="topMenu">
				<ul>
					...
					<li class="topMenuLi"><a class="menuLink" href="/iSpace/view/BOARD/suggest.jsp">SUGGEST </a></li>


					<li class="topMenuLi" style="background-color: #df633a;"><a class="menuLink" style="color: white;" href="/iSpace/view/BOARD/lnf.jsp">LOST&FOUND </a></li>
	...
	<div id='containn'>
		...
		<div id='box-center'>
			...
			<div class="container" style="padding-top: 50px; width: 100%;">
				<div class="row">
					<form action="/iSpace/UpdateService" method="post" enctype="multipart/form-data">

						<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd">
							<thead>

								<tr>
									<th colspan="2" style="background-color: white; text-align: center; font-size: 25px;">분실물게시판</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									<td colspan="2">
										<input type="text" class="form-control" placeholder="글 제목" name="lnfTitle" maxlength="50" value="<%=lnf.getLnfTitle()%>">
									</td>
								</tr>

								<tr>
									<td>
										<textarea class="form-control" placeholder="글 내용" name="lnfContent" maxlength="2048" style="height: 200px; width: 100%;"><%=lnf.getLnfContent()%></textarea>
									</td>
								</tr>
								<tr>
									<td colspan="2">
										<input type="file" value="파일 선택" name="lnfFile" />
								</tr>
								<tr>
									<td style="text-align: left;">
										현재 파일 : <img style="width: 100px;" src="/iSpace/upload/<%=lnf.getLnfFile()%>"> <br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
										<%=lnf.getLnfFile()%></td>
								</tr>
