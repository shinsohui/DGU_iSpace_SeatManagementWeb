	...
	<div class="container" style= "padding-top:100px; width : 980px;" >
		<div class="row">
			...
			<table width="980px" border="1">
			 <%
                  String idx=request.getParameter("commuId");
               ...
               <tr>
                  <td><%=list.get(i).getIdx()%>&nbsp&nbsp&nbsp&nbsp</td>
                  
                  <td><%=list.get(i).getWriter()%>&nbsp&nbsp&nbsp&nbsp</td>
                    
                  <td><%=list.get(i).getDate()%>&nbsp&nbsp&nbsp&nbsp</td>
		...
		<br>
				...
				<tr>
				<td width="70px">댓글</td>
				<td><textarea rows="3" cols="120" name="content" placeholder="댓글을 입력해주세요."></textarea></td>
			...
			<a onclick="return confirm('정말로 삭제하시겠습니까?')"
				href="deleteCommuAction.jsp?bbsID=<%=commuId%>" class="btn btn-primary pull-right">삭제</a>
