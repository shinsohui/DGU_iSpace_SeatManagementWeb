...
<body>
   ...
   <table>
      <tr>
         <td><input type="text" name="id" placeholder="ID" autocomplete="on" tabindex="1"></td>
         <td rowspan=2><input type="submit" value="LOGIN" tabindex="3"></td>

      </tr>

      <tr><td><input type="password" name="pw" placeholder="PW" autocomplete="off" tabindex="2"></td></tr>
   </table>
   </form>
</body>
</html>